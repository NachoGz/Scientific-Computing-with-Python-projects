...
def add_time(start, duration, day=None):
    ...
    # pongo por encima de dhour para saber por la suma de minutos si hay una hora extra
    ...
    if format == 'PM':
        ...
        if (int(dhour)%24) >= (limit-int(shour)):
            format = 'AM'
            cdays += 1
...
# arreglar problema del formato pm a am y viceversa
# arreglar problema con el conteo de los dias